...
public class FtpUploadUtil {
    ...
    public static String uploadFile(MultipartFile source) throws IllegalStateException, IOException {
        ...
        // 服务器路径：上传基础位置 ObsPathEnums.图片.getPath();
        // 服务器上目标文件夹（日期文件夹）
        String filePath = "/" +  DateUtil.currentDate();
        ...
        // 上传到FTP服务器
        String FTP_FILE_PATH = FtpFileUtil.uploadFile(ObsPathEnums.图片.getPath(), filePath, fileName, inputStream);
